# DH.NCore / PeiKeSmart 项目文档生成 Prompt
...
3. 关联 Doc/ 目录下的文档文件
4. 关联项目当前文档 URL；若外部文档仍沿用历史站点域名，保留兼容链接并在文档中说明
...
适用场景：新 PeiKeSmart 项目从零开始建立文档。

```
这是一个新的 PeiKeSmart 生态项目，请帮我初始化文档体系：

1. 扫描项目源码结构
2. 创建 Doc/ 目录及以下文件：
    - AI功能索引.md（参考 DH.NCore 的格式）
   - 核心库目录.md（文档链接目录）
   - 至少为最核心的 3 个公共类创建文档
3. 创建 .github/ 目录及以下文件：
...
参考文档：
- DH.NCore 的 Doc/文档标准模板.md
- DH.NCore 的 Doc/AI协作开发指南.md
- DH.NCore 的 .github/copilot-instructions.md
```
